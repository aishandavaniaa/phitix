...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2022 at 09:10 AM
...
INSERT INTO `data_ayam` (`id`, `tanggal_masuk`, `jumlah_masuk`, `harga_satuan`, `total_harga`, `mati`) VALUES
(1, '2022-08-09', 100, 0, 0, 9),
(2, '2022-10-12', 100, 0, 0, 9),
(5, '2022-12-04', 150, 0, 0, 7);
...
INSERT INTO `detail_pakan` (`id`, `pembelian`, `jenis_pakan`, `stok_pakan`, `harga_kg`, `total_harga`) VALUES
(1, '2022-09-08', 'Dedak Padi', 50, 0, 1000000),
(2, '2022-09-02', 'Sorgum', 69, 0, 2000000);
...
INSERT INTO `distribusi` (`id`, `customer`, `tanggal_distribusi`, `contact`, `total_ayam`, `harga_satuan`, `payment`, `address`) VALUES
(1, 'Aishanda', '2022-10-09', 812345678, 23, 0, 2500000, 'Nias Cluster'),
(2, 'Vania', '2022-10-17', 813456788, 50, 0, 1000000, 'Taman Anggrek');
...
INSERT INTO `tenaga_kerja` (`id_karyawan`, `nama_karyawan`, `jabatan`, `gaji`) VALUES
(2, 'Tarjo', 'Karyawan', 700000),
(3, 'Caezarr', 'K.Peternakan', 5000000),
(4, 'Vani', 'Pengawas', 300000),
(6, 'Caca', 'Peternak', 200000);
...
INSERT INTO `vaksin_detail` (`id`, `tanggal_ovk`, `jenis_ovk`, `jumlah_ayam`, `next_ovk`, `biaya_ovk`, `total_biaya`) VALUES
(1, '2022-09-21', 'Za', 68, '2022-09-29', 7000, 0);
