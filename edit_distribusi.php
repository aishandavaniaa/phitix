...
$id = $_GET['id'];
$query = "SELECT * FROM distribusi WHERE id='$id'";
                ...
                <!-- Nested Row within Card Body -->
                        ...
                        <div class="p-2">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Edit Data Distribusi</h1>
                            </div>
                            <form class="user" action="edit_distribusi.php" method="POST">
                                <div class="form-group">
                                    <input type="hidden" class="form-control form-control-user" id="exampleInputId" name="id" value="<?php echo $id; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Nama Customer</label>
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="customer" value="<?php echo $customer; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Tanggal</label>
                                    <input type="text" class="form-control form-control-user" id="exampleInputPassword" name="tanggal_distribusi" value="<?php echo $tanggal_distribusi; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Kontak</label>
                                    <input type="text" class="form-control form-control-user" id="exampleInputUsername" name="contact" value="<?php echo $contact; ?>">
                                </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <label>Payment</label>
                                    <input type="text" class="form-control form-control-user" id="exampleInputUsername" name="payment" value="<?php echo $payment; ?>">
                                </div>
                                   </div>
                                    <div class="form-group">
                                    <label>Address</label>
                                    <input type="text" class="form-control form-control-user" id="exampleInputUsername" name="address" value="<?php echo $address; ?>">
                                </div>
                                <hr>
