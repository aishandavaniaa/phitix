...
if( isset($_POST['insert_data']) ){
    ...
    $ambil = $koneksi->query("INSERT INTO vaksin_detail  (tanggal_ovk,jenis_ovk,jumlah_ayam,next_ovk,biaya_ovk,total_biaya) VALUES ('$tanggal_ovk', '$jenis_ovk','$jumlah_ayam','$next_ovk','$biaya_ovk','$total_biaya')");
                ...
                <!-- Nested Row within Card Body -->
                        ...
                        <div class="p-2">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Insert OVK</h1>
                            </div>
