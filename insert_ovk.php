...
if( isset($_POST['insert_data']) ){
    ...
    // $tanggal_ovkk = date('Y-m-d', strtotime($tanggal_ovk));
    $jenis_ovk   = $_POST['jenis_ovk'];
    $jumlah_ayam   = $_POST['jumlah_ayam'];
    $next_ovk = $_POST['next_ovk'];
    // $next_ovkk = date('Y-m-d', strtotime($next_ovk));
    $biaya_ovk = $_POST['biaya_ovk'];
    //$total_biaya = $_POST['total_biaya'];

   $query = "INSERT INTO vaksin_detail  (tanggal_ovk,jenis_ovk,jumlah_ayam,next_ovk,biaya_ovk,total_biaya) VALUES ('$tanggal_ovk', '$jenis_ovk','$jumlah_ayam','$next_ovk','$biaya_ovk','$total_biaya')";
                ...
                <!-- Nested Row within Card Body -->
                        ...
                        <div class="p-2">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Insert Data OVK</h1>
                            </div>
                            <form class="user" method="POST">
                                ...
                                <label>Tanggal OVK</label>
                                    <input type="date" class="form-control form-control-user" name="tanggal_ovk">
                                </div>
                                <div class="form-group">
                                <label>Jenis OVK</label>
                                    <input type="text" class="form-control form-control-user" name="jenis_ovk">
                                </div>
                                <div class="form-group">
                                <label>Jumlah Ayam</label>
                                    <input type="number" class="form-control form-control-user input" id="jmlmasuk" name="jumlah_ayam">
                                </div>  
                                <div class="form-group">
                                <label>next OVK</label>
                                    <input type="date" class="form-control form-control-user input"  name="next_ovk">
                                </div>  
                                <div class="form-group">
