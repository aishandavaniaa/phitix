                        ...
                        <div class="p-2">
                            ...
                            <form class="user" action="edit_pendapatan.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control form-control-user" id="exampleInputEmail" name="tanggal" value="<?php echo $tanggal; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Pemasukan</label>
                                    <input type="number" class="form-control form-control-user" id="exampleInputEmail" name="pemasukan" value="<?php echo $pemasukan; ?>">
                                </div>
                                <div class="form-group">
