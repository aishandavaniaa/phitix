...
if( isset($_POST['update']) ){
    ...
    $query = "UPDATE detail_pakan SET pembelian='$pembelian', jenis_pakan='$jenis_pakan', stok_pakan='$stok_pakan', total_harga='$total_harga' WHERE id='$id'";
    echo $query;
    $result = mysqli_query($koneksi, $query);
    header('Location: pakan.php');
}
$id = $_GET['id'];
$query = "SELECT * FROM detail_pakan WHERE id='$id'";
            ...
            <div class="card-body w-75 vh-50 ">
                <!-- Nested Row within Card Body -->
                        ...
                        <div class="p-2">
                            ...
                            <form class="user" action="edit_pakan.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="exampleInputPassword" name="jenis_pakan" value="<?php echo $jenis_pakan; ?>">
                                </div>
                                <div class="form-group">
